...
const RANKS = ['3', '4', '5', '6', '7', '8', '9', 'T', 'J', 'Q', 'K', 'A', '2']; // 点数顺序
...
// Function to compare two single cards in Big Two
function compareCards(card1, card2) {
    ...
    // If cards have different ranks, compare by rank
    if (rankIndex1 !== rankIndex2) {
        return rankIndex1 - rankIndex2;
    }

    // If cards are both 3s, compare by the special suit order
    if (card1.rank === '3') {
        const specialSuitOrder = ['C', 'D', 'H', 'S'];
        return specialSuitOrder.indexOf(card1.suit) - specialSuitOrder.indexOf(card2.suit);
    } else {
...
module.exports = {
    ...
    comparePlays,
    checkPlay,
    compareCards, // Export compareCards
    SUITS,
    RANKS,
    rankOrder,
    suitOrder
